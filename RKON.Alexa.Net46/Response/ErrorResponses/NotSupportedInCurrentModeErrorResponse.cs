...
namespace RKon.Alexa.NET46.Response.ErrorResponses
{
    ...
    public class NotSupportedInCurrentModeErrorResponse : ErrorResponse
    {
        ...
        /// CurrentDeviceMode has to be a valid mode. These can be found in RKon.Alexa.NET46.Types.DeviceModes.Modes.
        ...
        public NotSupportedInCurrentModeErrorResponse(RequestHeader reqHeader, string currentDeviceMode)
        {
            ...
            Header = setHeader(reqHeader, RKon.Alexa.NET46.Types.HeaderNames.NOT_SUPPORTED_IN_CURRENT_MODE_ERROR);
