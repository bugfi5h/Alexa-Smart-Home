    ...
    public class BrightnessController_SetBrightness_Request
    {
       ...
       private const string SET_BRIGHTNESS_RESPONSE = @"
        ...
        public void ResponseCreationTest()
        {
            ...
            // Property 1
            TestFunctionsV3.TestContextProperty(responseFromString.Context.Properties[0], PropertyNames.BRIGHTNESS, Namespaces.ALEXA_BRIGHTNESSCONTROLLER, "2017-09-27T18:30:30.45Z", 200, null);
