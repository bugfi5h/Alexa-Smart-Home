...
namespace RKon.Alexa.Net.Tests.V3.Requests
{
    public class PercentageController
    {
        ...
        [Fact]
        public void ResponseParse_Percentage_Test()
        {
        ...
        [Fact]
        public void ResponseCreation_AdjustPercentage_Test()
        {
            SmartHomeRequest request = JsonConvert.DeserializeObject<SmartHomeRequest>(ADJUST_PERCENTAGE);
            ...
            Property p = new Property(Namespaces.ALEXA_PERCENTAGECONTROLLER, PropertyNames.PERCENTAGE,
               74, DateTime.Parse("2017-09-27T18:30:30.45Z").ToUniversalTime(), 200);
            ...
            Util.Util.WriteJsonToConsole("Percentage", response);
        }
        #endregion
    }
}
