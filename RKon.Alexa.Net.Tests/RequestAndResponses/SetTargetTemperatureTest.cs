...
namespace RKon.Alexa.Net.Tests.RequestAndResponses
{
    public class SetTargetTemperatureTest
    {
        ...
        public void RequestCreationTest()
        {
            ...
            //Header Check
            TestFunctions.TestRequestHeader(requestFromString.Header, "b6602211-b4b3-4960-b063-f7e3967c00c4", Namespaces.CONTROL, HeaderNames.SET_TARGET_TEMPERATURE_REQUEST);
            //Payload Check
        ...
        public void ResponseCreationTest()
        {
            ...
            //Header Check
            TestFunctions.TestResponseHeader(response.Header, requestFromString.Header.Namespace, HeaderNames.SET_TARGET_TEMPERATURE_REQUEST);
            //Payload Check
