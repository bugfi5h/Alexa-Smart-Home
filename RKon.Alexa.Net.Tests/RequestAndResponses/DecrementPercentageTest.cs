...
{
    public class DecrementPercentageTest
    {
        private const string DECREMENT_PERCENTAGE_REQUEST = @"
        {
          'header': {
        ...
        {
            SmartHomeRequest requestFromString = JsonConvert.DeserializeObject<SmartHomeRequest>(DECREMENT_PERCENTAGE_REQUEST);
            //Header Check
            TestFunctions.TestRequestHeader(requestFromString.Header, "ABC-123-DEF-456", Namespaces.CONTROL, HeaderNames.V2.DECREMENT_PERCENTAGE_REQUEST);
            //Payload Check
        ...
        public void ResponseCreationTest()
        {
            ...
            //Header Check
            TestFunctions.TestResponseHeader(response.Header, requestFromString.Header.Namespace, HeaderNames.V2.DECREMENT_PERCENTAGE_REQUEST);
            //Payload Check
            ...
            Util.Util.WriteJsonToConsole("DecrementPercentageConfirmation", response);
        }
    }
}
