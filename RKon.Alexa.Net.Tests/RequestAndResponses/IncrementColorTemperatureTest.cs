...
namespace RKon.Alexa.Net.Tests
{
    public class IncrementColorTemperatureTest
    {
        ...
        public void RequestCreationTest()
        {
            ...
            //Header Check
            TestFunctions.TestRequestHeader(requestFromString.Header, "ABC-123-DEF-456", Namespaces.CONTROL, HeaderNames.INCREMENT_COLOR_TEMPERATURE_REQUEST);
            //Payload Check
        ...
        public void ResponseCreationTest()
        {
            ...
            //Header Check
            TestFunctions.TestResponseHeader(response.Header, requestFromString.Header.Namespace, HeaderNames.INCREMENT_COLOR_TEMPERATURE_REQUEST);
            //Payload Check
